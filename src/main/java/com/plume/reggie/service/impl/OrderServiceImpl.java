...
import com.plume.reggie.entity.*;
import com.plume.reggie.mapper.OrderMapper;
import com.plume.reggie.service.*;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Orders> implements OrderService {
    ...
    public void submit(Orders orders) {
        ...
        List<ShoppingCart> shoppingCarts = shoppingCatService.list(wrapper);
        ...
        // 清空购物车数据
        shoppingCatService.remove(wrapper);
    }
