...
import com.plume.reggie.entity.DishFlavor;
import com.plume.reggie.service.CategoryService;
import com.plume.reggie.service.DishFlavorService;
...
public class DishController {
   ...
   /* @GetMapping("/list")
    public R<List<Dish>> list(Dish dish){
        ...
        queryWrapper.eq(Dish::getStatus,1); //添加条件:状态为1起售状态的菜品
        // 添加排序条件
    ...
    public R<List<DishDto>> list(Dish dish){
        ...
        // 动态构造key
        String key = "dish_" + dish.getCategoryId() + "_" + dish.getStatus();//dish_3423234234324234_1
